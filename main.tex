...
\begin{acronym}[XXXX] % Use [XXXX] for proper acronym alignment
    ...
    \acro{BIA}{Business Impact Analysis}
    ...
    \acro{MAD}{Maximum Allowable Downtime}
    ...
    \acro{GCPP}{General Contingency-Planning Policy}
    \acro{IRPP}{Incident-Response Planning Policy}
    \acro{IRP}{Incident Response Plan}
    \acro{DRP}{Disaster Recovery Plan}
    \acro{DRPP}{Disaster-Recovery Planning Policy}
    \acro{BCPP}{Business-Continuity Planning Policy}
    \acro{BCP}{Business Continuity Plan}
    \acro{IRT}{Incident Response Team}
    \acro{RTO}{Recovery Time Objective}
    \acro{RPO}{Recovery Point Objective}
    \acro{MTTD}{Mean Time to Detect}
...
\bibliography{refs}           % if your file is refs.bib
