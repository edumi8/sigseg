...
IRPP, DRPP and BCPP add discipline-specific requirements.

%------------------------------------------------------------------
\section{General Contingency-Planning Policy (GCPP)}
\subsection*{Purpose}
...
\begin{enumerate}[label=\arabic*.]
  ...
  \item \textbf{Hierarchy \& integration}\,—Department-level plans (IR, DR,
        BC) must align with and reference the GCPP.
...
\midrule
\endhead
Board of Directors & Approve the GCPP and resource its implementation.\\[2pt]
Chief Information Security Officer (CISO) & Own the framework and coordinate
audits.\\[2pt]
...
workshops for Engineering \& Grid Operations owing to SCADA criticality.
...
%------------------------------------------------------------------
\section{Incident-Response Planning Policy (IRPP)}
\label{sec:IRPP}
\subsection*{Purpose}
...
affecting IT or OT (e.g.\ SCADA manipulation, ERP data breach, phishing).

\subsection*{Policy Requirements}
\begin{enumerate}[label=\arabic*.]
  \item \textbf{Incident-Response Team (IRT)} consisting of: Incident
  ...
  \item \textbf{15-minute reporting rule}\,—Employees must inform the SOC or
        on-call IRT within 15 minutes of discovery.
...
%------------------------------------------------------------------
\section{Disaster-Recovery Planning Policy (DRPP)}
\label{sec:DRPP}
\subsection*{Purpose}
Restore essential ICT and OT services—including SCADA control, cloud
analytics and ERP—to their agreed Recovery Time Objective (RTO) and
Recovery Point Objective (RPO) after a disruption.
...
%------------------------------------------------------------------
\section{Business-Continuity Planning Policy (BCPP)}
\label{sec:BCPP}
\subsection*{Purpose}
